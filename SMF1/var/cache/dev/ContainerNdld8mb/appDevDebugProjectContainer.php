...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'app.redirect_after_registration_subscriber' => 'getApp_RedirectAfterRegistrationSubscriberService.php',
        ...
        $this->privates = [
            ...
            'app.redirect_after_registration_subscriber' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('D8141vesLE', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G+U9lPjIFS', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webp', ($this->targetDirs[3].'/web/'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zY1-13wVo-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ivYqgc9brs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q5Yt9PQWPP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('fos_user.registration.success', [0 => function () {
            return ${($_ = isset($this->services['app.redirect_after_registration_subscriber']) ? $this->services['app.redirect_after_registration_subscriber'] : $this->load('getApp_RedirectAfterRegistrationSubscriberService.php')) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MainBundle/Resources/views'), '!Main');
        $instance->addPath(($this->targetDirs[3].'\\src\\ScolariteBundle/Resources/views'), 'Scolarite');
        $instance->addPath(($this->targetDirs[3].'\\src\\ScolariteBundle/Resources/views'), '!Scolarite');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'KnpSnappyBundle' => [
                    'parent' => NULL,
                    'path' => 'C:/wamp64/www/SMF1/SMF1/vendor/knplabs/knp-snappy-bundle',
                    'namespace' => 'Knp\\Bundle\\SnappyBundle',
                ],
                'ScolariteBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ScolariteBundle'),
                    'namespace' => 'ScolariteBundle',
                ],
                'GestionBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\GestionBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ScolariteBundle' => 'ScolariteBundle\\ScolariteBundle',
