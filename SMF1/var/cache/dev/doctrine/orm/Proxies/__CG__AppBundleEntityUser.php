...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'score', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'pays', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nivexper', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nivetud', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'urllogopro', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'titre', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getNivetud()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNivetud', []);

        return parent::getNivetud();
    }
    ...
    public function setNivetud($nivetud)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNivetud', [$nivetud]);

        return parent::setNivetud($nivetud);
    }
    ...
    public function setUrllogopro($urllogopro)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUrllogopro', [$urllogopro]);

        return parent::setUrllogopro($urllogopro);
    }
    ...
    public function getUrllogopro()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUrllogopro', []);

        return parent::getUrllogopro();
    }
    ...
    public function getNivexper()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNivexper', []);

        return parent::getNivexper();
    }
    ...
    public function setNivexper($nivexper)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNivexper', [$nivexper]);

        return parent::setNivexper($nivexper);
    }
