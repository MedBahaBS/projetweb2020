...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ScolariteBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\GestionBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'ScolariteBundle\\Entity');
$b->addDriver($c, 'GestionBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'ScolariteBundle' => 'ScolariteBundle\\Entity', 'GestionBundle' => 'GestionBundle\\Entity']);
