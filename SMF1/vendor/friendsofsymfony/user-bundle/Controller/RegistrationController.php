...
class RegistrationController extends Controller
{
    ...
    public function registerAction(Request $request)
    {
        ...
        return $this->render('@Main/FOSBundleUser/Registration/register.html.twig', array(
    ...
    {
        $user = $this->userManager->createUser();
//        $user->setRoles(array('PREST'=>'ROLE_PREST'));
        $user->setRoles(array('ENSEIGNANT'=>'ROLE_ENSEIGNANT'));
        $user->setEnabled(true);
        ...
        return $this->render('@Main/FOSBundleUser/Registration/register1.html.twig', array(
            'form' => $form->createView(),
        ));
    }
    ...
    public function register2Action(Request $request)
    {
        $user = $this->userManager->createUser();
//        $user->setRoles(array('PREST'=>'ROLE_PREST'));
        $user->setRoles(array('Eleve'=>'ROLE_ELEVE'));
        $user->setEnabled(true);
        ...
        return $this->render('@Main/FOSBundleUser/Registration/register2.html.twig', array(
            'form' => $form->createView(),
        ));
    }
