...
class monController extends Controller
{
    ...
    public function envoyernewsletterAction(Request $request)
    {
        ...
        $listeEmail=$this->getDoctrine()->getRepository(inscritionEmail::class)->findAll();
        ...
        return $this->render('@cantine/mon/contact.html.twig', array(
    ...
    public function validerAction($id)
    {
        ...
        $user=$inscription->getUser();
              ...
              $message = (new \Swift_Message('confirmation inscription cantine'))
                  ->setFrom('genuis.school.pidev@gmail.com')
                  ->setTo($user->getEmail()) //
        ...
        $this->get('mailer')->send($message);
            ...
            $inscription=$this->getDoctrine()->getRepository(inscription::class)->find($id);
            $user=$inscription->getUser();
            $message = (new \Swift_Message('echec d\'inscription dans la cantine'))
                ->setFrom('genuis.school.pidev@gmail.com')
